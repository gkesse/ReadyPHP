...
set "GPROJECT_PATH=%GPROJECT_ROOT%\ReadyPHP"
::===============================================
...
set "GCOMPOSER_INSTALL_PATH=C:\Users\Admin\Downloads\Programs\ReadyPHP\webroot\libs"
::
set "GCOMPOSER_INSTALL_PKG=phpoffice/phpspreadsheet"
set "GCOMPOSER_INSTALL_PKG=dompdf/dompdf"
set "GCOMPOSER_INSTALL_PKG=amenadiel/jpgraph:^4"
set "GCOMPOSER_INSTALL_PKG=symfony/filesystem:^5.2"
::===============================================
...
::===============================================
set "GGIT_URL=https://github.com/gkesse/ReadyPHP.git"
set "GGIT_NAME=ReadyPHP"
::===============================================
